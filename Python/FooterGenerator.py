...
class FooterGenerator:
    ...
    def get_footer(self):
        ...
        if str(day).startswith('0'):
            ...
            day = day.split('0')[1]
        if timeBinary == 0:
            self.footer = ("KIPP | "+weekday+" "+strmonth+" "+str(day)+ending+", "+str(year)+" at "+hour+":"+minute+" AM")
        if timeBinary == 1:
            self.footer = ("KIPP | "+weekday+" "+strmonth+" "+str(day)+ending+", "+str(year)+" at "+hour+":"+minute+" PM")
        return self.footer
