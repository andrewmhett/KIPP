...
OWON("!BLOCK", "This command will block the specified user, deleting all messages they send\n!BLOCK|user or 'ALL'",
     BLOCK, [str])
OWON("!WCHANNEL", "This command will set the current text channel as the channel where welcoming messages are sent whenever someone joins the server\n!WCHANNEL", WCHANNEL, [])
OWON("!INVITE", "This command will DM an invite to the user with the specified user id\n!INVITE|user id",
     INVITE, [int])
OWON("!UNBLOCK", "This command will unblock the specified user\n!UNBLOCK|user",
     UNBLOCK, [str])
